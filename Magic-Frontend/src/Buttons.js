          ...
          <div className='col-md-12'>
            <div className='row d-flex align-items-center justify-content-center buttonContainer'>
              <Button
                ...
                loading={
                  this.state.loading && this.state.buttonLoading === 'RED'
                }
                className='m-4'
              ...
              <Button
                ...
                disabled={this.state.loading}
                loading={
                  this.state.loading && this.state.buttonLoading === 'GREEN'
                }
                className='m-4'
              ...
              <Button
                ...
                disabled={this.state.loading}
                loading={
                  this.state.loading && this.state.buttonLoading === 'BLUE'
                }
                className='m-4'
              ...
              <Button
                ...
                disabled={this.state.loading}
                loading={
                  this.state.loading && this.state.buttonLoading === 'YELLOW'
                }
                className='m-4'
